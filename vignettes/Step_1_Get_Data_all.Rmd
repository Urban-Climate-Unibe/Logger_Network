...
data <- Logger_data("Bern", date_start = "2024-07-20", date_end = "2024-07-23", interpolate = 0, write_csv = T)
```
...
data <- Logger_data("thun", date_start = "2024-07-01", interpolate = 0, write_csv = F)
