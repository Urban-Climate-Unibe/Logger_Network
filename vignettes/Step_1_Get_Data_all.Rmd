...
data <- Logger_data("Bern", date_start = "2024-05-01",interpolate = 0, write_csv = T)
data <- Logger_data("Thun", date_start = "2024-06-04", date_end = "2024-06-05", interpolate = 0, write_csv = F)
...
leaflet::leaflet(metadata) |>
  ...
  leaflet::addCircleMarkers(~OST_CHTOPO, ~NORD_CHTOPO, 
                            ...
                            popup = paste(
                             "<strong>Measurement type: </strong>", round(metadata$missing))) |> #add link to database or publication) |>
