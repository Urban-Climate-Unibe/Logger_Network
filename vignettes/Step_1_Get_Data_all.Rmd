...
data <- Logger_data("Bern", date_start = "2024-06-01",interpolate = 0, write_csv = T)
data <- Logger_data("Thun", date_start = "2024-07-06", date_end = "2024-07-16", interpolate = 0, write_csv = F)
...
metadata <- read.csv("../Metadata/Bern/metadata_static.csv") |>
